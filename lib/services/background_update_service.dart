...
/// 백그라운드에서 실시간 업데이트를 모니터링하고 알림을 전송하는 서비스
class BackgroundUpdateService {
  static const String _notificationChannelId = 'update_notification_channel';
  static const String _foregroundChannelId = 'update_monitor_foreground_channel';
  
  static final FlutterLocalNotificationsPlugin _notificationsPlugin =
      FlutterLocalNotificationsPlugin();

  /// 백그라운드 서비스 및 알림 플러그인 초기화
  static Future<void> initialize() async {
    ...
    // 2. 알림 플러그인 초기화 (앱이 켜져 있을 때 및 꺼져 있을 때의 핸들링)
  ...
  static Future<bool> onStartBackground(ServiceInstance service) async {
  ...
  /// 실제 업데이트 체크 프로세스 비즈니스 로직
  static Future<void> _performUpdateCheckFlow(ServiceInstance? service) async {
    try {
  ...
  /// 네이티브 알림창에 클릭 가능한 푸시 알림 띄우기
  static Future<void> _showUpdatePushNotification(UpdateInfo info) async {
